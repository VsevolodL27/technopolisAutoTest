...
public class TestMessageData {
    ...
    public static final String username2 = "Ivan Ivanov";
    public static final String userLogin2 = "ivanov@list.ru";
    public static final String userPassword2 = "12345678";
    public static final Long userId2 = 123456789L;
}
